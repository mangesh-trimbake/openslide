...
def slide(path):
    ...
    print("=============================")
    print("slide_url "+str(slide_url)+ " slide_filename "+str(slide.filename)+"  slide_mpp  "+str(slide.mpp) )
    print("=============================")
...
def tile(path, level, col, row, format):
    ...
    print("format")
    print(slide)
    print("lvl",level,col ,row,format)
    print("level available",slide.level_count);
    format = format.lower()
